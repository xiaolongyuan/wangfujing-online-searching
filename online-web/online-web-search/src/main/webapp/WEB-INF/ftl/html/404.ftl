...
<div class="errordiv">
    <div class="wrap">
        <#--noinspection HtmlUnknownTarget-->
        <div class="imgs"><img src="<@randomLocation hosts=cssHosts template=cssLocationTemplate/>/img/404.png" class="er-img"></div>
        <div class="tc er-text">
            <div class="er-e">
                <span class="gray">ERROR</span>
                <span class="red">出错了～！</span>
            </div>
            <div class="er-c">您访问的页面不存在～！</div>
