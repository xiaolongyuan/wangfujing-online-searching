        ...
        <ul id="history_maybe_like" class="like_list clearfix">
            <#list list as pro>
                <li>
                    ...
                    <div class="item_txt">
                        <a target="_blank" href="${itemUrlPrefix}${pro.spuId}${itemUrlPostfix}" class="name"><#if !pro.longDesc?? || pro.longDesc?length == 0>${pro.title} ${pro.shortDesc!}<#else>${pro.longDesc} ${pro.title}</#if></a>
