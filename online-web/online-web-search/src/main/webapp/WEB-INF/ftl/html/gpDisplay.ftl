...
<#--noinspection HtmlUnknownTarget-->
    ...
    <title>${result.params.gpTitle}</title>
</head>
<body>
${tbarContent}
${headerContent}
...
<div class="brandMain clearfix">
    <div class="wrap">
        ...
        <#--noinspection HtmlUnknownTarget-->
            <a class="link" href="${wwwLocation}"><strong>首页</strong></a>&gt; ${result.params.gpTitle}
        </div>
                            ...
                            <td>
                                <ul class="goodsList">
                                    <#list result.filters.availableBrands.availables as brand>
                                        <#assign _c = false>
                                        <#list result.params.selectedBrands.selected as selectBrand>
                                            <#if selectBrand.id = brand.id>
                                                <#assign _c = true>
                                                <#break>
                                            </#if>
                                        </#list>
