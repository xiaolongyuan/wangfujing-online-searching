...
<#-- @ftlvariable name="cats" type="java.lang.String" -->
...
<#--noinspection HtmlUnknownTarget-->
    ...
    <title><#list result.params.selectedCategories as sc>${sc.display}<#if sc_has_next> - </#if></#list></title>
</head>
<body>
${tbarContent}
${headerContent}
...
<input type="hidden" id="cats4MayLike" value="${cats}">
<#--noinspection HtmlUnknownTarget-->
