/* wfj-1.0.0/ dropdown.js Date:2015-12-11 15:43:35 */
!function (a) {
            ...
            if (c) {
                ...
                a('<div class=\'ui-dialog-autoclose\'><span id=\'ui-autoclose\'>' + d + '</span>秒后自动关闭</div>').appendTo(this.el),
                    ...
                    window.autoCloseTimerDialog = setInterval(function () {
                        ...
                        0 == d && (d = c, b.close(), clearInterval(window.autoCloseTimerDialog))
                    }, 1000),
                    this.updateMain()
            }
        },
...
!function (a) {
    ...
    var j = function (a, b, c) {
        ...
        if (c.expires && ('number' == typeof c.expires || c.expires.toUTCString)) {
            var e;
            'number' == typeof c.expires ? (e = new Date, e.setTime(e.getTime() + 24 * c.expires * 60 * 60 * 1000))  : e = c.expires,
    ...
    function l(a) {
        var b = arguments;
        if (b.length > 1) {
            for (var c = 0, d = b.length; d > c; c++) if (l(b[c])) return !0;
            return !1
        }
    ...
    function n() {
        ...
        if (h.provinceList && h.provinceList.length > 0) a = h.provinceList;
        else {
            for (var b in h.province) a.push({
                id: b,
                name: h.province[b]
            });
            h.provinceList = a
    ...
    function o(a) {
        ...
        c || (c = h.province[e[0]], d = 1, b.id = e[0]),
            b.name = c,
        {
            value: b,
            isDefault: d
    ...
    function r(b, c, d) {
        a.each(q(b), function (a, b) {
            l(b.id) || 0 == b.id || (c.push(b.id), d.push(b.name))
        })
    }
    function s(b, c, d, e) {
        var f = '';
        if (c.name.length >= d.longerAreaSize ? f = 'longer-area' : c.name.length >= d.longAreaSize && (f = 'long-area'), e && d.className.selected || f) {
            var g = a(b);
    ...
    function u() {
        ...
        a('.' + e.content_content, c).undelegate('a[data-id]', 'click').delegate('a[data-id]', 'click', function (f) {
            ...
            a('.' + e.content_content, c).undelegate('a[data-onchange=1]', 'click').delegate('a[data-onchange=1]', 'click', function () {
                var f = a(this);
                d.className.selected && (a('.' + e.content_content + ' a.' + d.className.selected, c).removeClass(d.className.selected), f.addClass(d.className.selected)),
                d.selectedClose && x.call(b, !1),
    ...
    function x(a) {
        ...
        a ? (g > - 1 && (clearTimeout(g), g = - 1), y.call(b), b.el.addClass(c), g = setTimeout(function () {
            b.el.addClass(c)
        }, 1))  : (g > - 1 && (clearTimeout(g), g = - 1), b.el.removeClass(c))
    }
    function y() {
        var b = this;
        var d = b.el;
        ...
        if (e.data('left') ? e.css('left', e.data('left'))  : e.data('left', e.css('left')), i + g > h) {
            var k = g - f - 10;
            k > j && (k -= k - j + f - 20),
                e.css({
                    left: '-' + k + 'px'
                })
        } else i < - 1 * parseInt(e.css('left')) && e.css({
            left: '0px'
        })
    }
    function z(a) {
    ...
    function A(a, b) {
        ...
        return d = d && d.split('-') || [0,
            0,
            0,
            0],
            'object' == typeof b ? d = z(b)  : (d = h.city[b], d && (d = (d + '-0').split('-'))),
            d = d.join('-'),
    ...
    a.ui.define('areamini', {
        ...
        init: function () {
            ...
            c.provinceList && c.provinceExtend && (c.provinceList = a.extend(!0, [
            ], n().concat(c.provinceList))),
                p(c, function (e) {
                    C.call(b, e),
                        B.call(b, e, - 1);
...
!function () {
    ...
    var emitSectionText = function (a, b) {
        if (!(a.length <= 0)) {
            ...
            for (var g = 0; g < f.length; g++) emitSectionTextLine(f[g], b),
...
define('//misc.360buyimg.com/jdf/1.0.0/unit/login/1.0.0/login.js', [
    '//misc.360buyimg.com/jdf/1.0.0/unit/setUserInfo/1.0.0/setUserInfo.js',
    ...
    var i = function (a) {
        ...
        var b = {
            login: function () {
                ...
                return c ? void (location.href = a.loginUrl + '?ReturnUrl=' + escape(returnUrl))  : ($.closeDialog(), void (this.loginDialog = $('body').dialog({
                    title: '您尚未登录',
                    width: 410,
                    height: 420,
                    autoIframe: !1,
        ...
        if (f.regist = function () {
            ...
            var c = function (c) {
                if (null != c && (a.automatic && null != a.complete && a.complete(c), c.Identity.IsAuthenticated && null != a.complete && !a.automatic && a.complete(c), !c.Identity.IsAuthenticated && '' != a.loginUrl && !a.automatic)) if (a.modal) {
                    function e(b) {
                        null != a.complete && a.complete(b)
                    }
                    a.firstCheck && (b.login(), d.off('loginSuccessCallback'), d.on('loginSuccessCallback', e))
                } else location.href = a.loginUrl + '?ReturnUrl=' + escape(a.returnUrl)
            };
            a.firstCheck ? j(a, c)  : (b.login(), d.on('loginSuccessCallback', function (b) {
                null != a.complete && a.complete(b)
            }))
        }
    };
...
define('//misc.360buyimg.com/jdf/1.0.0/unit/event/1.0.0/event.js', [
], function () {
    var c = {
        on: function (a, b) {
            var c = this;
...
define('//misc.360buyimg.com/jdf/1.0.0/unit/hotkey/1.0.0/hotkey.js', [
], function () {
    function c() {
...
define('//misc.360buyimg.com/jdf/1.0.0/unit/globalReco/1.0.0/globalReco.js', [
], function () {
    var c = function (a) {
        if (this.param = $.extend({
                ...
                uuid: - 1,
                pin: readCookie('pin') || ''
            }, a.param), this.$el = a.$el, this.template = a.template, this.reBuildJSON = a.reBuildJSON, this.skuHooks = a.skuHooks || 'SKUS_recommend', this.ext = a.ext || {
    ...
    return c.prototype = {
        ...
        get: function () {
            ...
            if (pageConfig.product) for (d = 0; d < pageConfig.product.cat.length; d++) this.param['c' + (d + 1)] = pageConfig.product.cat[d];
            if (e) {
                for (var g in e) e.hasOwnProperty(g) && ('c1' == g || 'c2' == g || 'c3' == g ? c.param[g] = e[g] : f.push(g + ':' + e[g]));
                c.param.hi = f.join(',')
            }
            this.debug && console.info('//diviner.jd.com/diviner?' + decodeURIComponent($.param(this.param))),
                $.ajax({
                    ...
                    cache: !0,
                    jsonpCallback: 'call' + parseInt(100000 * Math.random(), 10),
                    success: function (a) {
...
/* jdf-1.0.0/ setUserInfo.js Date:2016-01-13 15:05:49 */
define('//misc.360buyimg.com/jdf/1.0.0/unit/setUserInfo/1.0.0/setUserInfo.js', [
], function () {
    var c = function (a) {
        a = $.extend({
...
/* jdf-1.0.0/ myjd.js Date:2016-01-05 17:06:56 */
define('//misc.360buyimg.com/jdf/1.0.0/unit/myjd/2.0.0/myjd.js', [
    ...
    var g = {
        ...
        bind: function () {
            ...
            this.el.dropdown({
                ...
                current: 'hover',
                onchange: function (a) {
                    a.attr('data-load') || (a.attr('data-load', 1), b.checkLoginInit())
                }
            })
        },
        checkLoginInit: function () {
            ...
            c({
                ...
                complete: function (b) {
                    if (b) {
                        var c = '';
                        b.Identity.IsAuthenticated ? (c = a.tpl(1, b.Identity.Unick), a.hasLoginInit())  : c = a.tpl(0, ''),
                            a.el.find('.dd').html(c),
                            a.viewlist(),
                            a.baitiaoInit()
                    }
                ...
                $.ajax({
                    ...
                    success: function (b) {
                        if (b) {
                            ...
                            b.lastLoginTime ? $('#lastLoginTime').html('上次登录：' + b.lastLoginTime).show()  : $('#lastLoginTime').hide()
                        }
                    }
                })
        },
            ...
            new e({
                ...
                callback: function (b, c) {
                    if (b && c) {
                        ...
                        var e = 0;
                        $.each(c, function (a, b) {
                            4 > e && b.sku && b.img && (d += '<div class="item"><a href="http://item.jd.com/' + b.sku + '.html" target="_blank" title="' + b.t + '"><img src="' + pageConfig.FN_GetImageDomain(b.sku) + 'n5/' + b.img + '" width="50" height="50" alt="' + b.t + '" /></a></div>', e++)
                        });
        ...
        baitiaoInit: function () {
            ...
            f('pin') ? this.baitiaoLinkSet(function (a) {
                ...
                3 == a.status && a.btUrl && c.html('<a href="' + a.btUrl + '" target="_blank">我的白条</a>'),
                    c.show()
...
define('//misc.360buyimg.com/jdf/1.0.0/unit/shortcut/2.0.0/shortcut.js', [
    '//misc.360buyimg.com/jdf/1.0.0/ui/dropdown/1.0.0/dropdown.js',
    ...
    function j() {
        ...
        $('#ttbar-mycity').html(c).areamini({
            ...
            onReady: function () {
                ...
                if (g.check() && b) {
                    var c = 'areaId';
                    g.get(c) ? g.get(c) != b && (g.set(c, b), g.clearByReg('^jd_home_2015_'))  : g.set(c, b)
                }
        ...
        $('#ttbar-apps').append(d).attr('aid', '2_955_6342').dropdown({
            ...
            current: 'hover',
            onchange: function (a) {
                a.attr('data-load') || (a.attr('data-load', 1), $.ajax({
...
define('//misc.360buyimg.com/jdf/1.0.0/unit/shoppingcart/2.0.0/shoppingcart.js', [
    '//misc.360buyimg.com/jdf/1.0.0/ui/dropdown/1.0.0/dropdown.js',
    ...
    var e = {
        ...
        FN_Refresh: function () {
            ...
            var e = function (b) {
                ...
                if (e > 0 ? (c.html(a.TPL_List.wrap.process(b.Cart)), c.find('#settleup-content .smc').html(f + g + h + j + i), $('#settleup-url').attr('href', pageConfig.shoppingcartUrl))  : c.html(a.TPL_NoGoods), $.browser.msie && 6 == $.browser.version) {
...
define('//misc.360buyimg.com/jdf/1.0.0/unit/category/2.0.0/category.js', [
    ...
    var c = {
        ...
        init: function (a) {
            ...
            if (c.mainId && (b.config.mainId = $(c.mainId)), c.el && (b.config.el = $(c.el)), b.config.mainId.attr('data-type') && (c.type = b.config.mainId.attr('data-type')), b.isHome() || 'home' == c.type) b.config.mainId.bind('mouseenter', function () {
                $(this).attr('data-load') || (b.getDataInit(), $(this).attr('data-load', 1)),
                    b.config.el.show()
            ...
            else if ('mini' == c.type) b.config.mainId.bind('mouseenter', function () {
                ...
                b.config.mainId.find('.dd').size() || (b.config.mainId.append('<div class="dd" style="display:none;"></div>'), b.config.el = function () {
                ...
                $.browser.msie && $.browser.version <= 7 && !pageConfig.wideVersion && d.css({
                    ...
                    b.config.mainId.bind('mouseenter', function () {
                        if ($(this).attr('data-load') || (b.getDataInit(), $(this).attr('data-load', 1)), b.config.el.show(), b.config.mainId.addClass('hover'), $.browser.msie) {
                            var a = 2;
                            $.browser.version < 9 && (a = 0, $.browser.version < 7 && (a = 5)),
        ...
        getDataInit: function (a, b, c) {
            ...
            $.ajax({
                ...
                success: function (e) {
                    'mini' == b ? (d.render2(e), d.bigiframe(d.config.el.find('.dd-inner')))  : (d.render(e), d.bigiframe(d.config.el.find('.dorpdown-layer')), d.bind(a)),
                    c && c()
                }
            })
        },
        ...
        getLinkHtml: function (a, b, c, d, e, f) {
            ...
            if ('undefined' != typeof d) {
                var k = '';
                2 == d ? (k = 'channel.jd.com', g[0] && (j = /^\d.*\d$/.test(g[0]) ? 'http://' + k + '/' + g[0] + '.html' : (/^http/.test(g[0]) ? '' : 'http://') + g[0]))  : 3 == d && (/^\d.*\d$/.test(g[0]) ? 2 == g[0].split('-').length ? j = 'http://channel.jd.com/' + g[0] + '.html' : 3 == g[0].split('-').length && (j = 'http://list.jd.com/list.html?cat=' + g[0].replace(/\-/g, ','))  : j = (/^http/.test(g[0]) ? '' : 'http://') + g[0])
            }
            ...
            return l = g[0] ? '<a href="' + j + '" ' + h + ' target="_blank">' : '<span>',
                g[2] ? (this.imgIndex > 4 && (this.imgIndex = 0), b = b ? ' width="' + b + '"' : '', c = c ? ' height="' + c + '"' : '', l += '<img src="//misc.360buyimg.com/lib/img/e/blank.gif" data-lazy-img="//img1' + this.imgIndex + '.360buyimg.com/' + g[2] + '"  ' + b + c + ' />', this.imgIndex += 1)  : l += (e ? e : '') + g[1] + (f ? f : ''),
                l += g[0] ? '</a>' : '</span>'
        },
        render: function (a) {
            var b = this;
            ...
            $.each(c, function (a, f) {
                ...
                $.each(c[a].s, function (d) {
                    ...
                    'n' == f.id && 0 == d && (i = !0, g += '<div class="subitems-main1">'),
                        $.each(e.s, function (a) {
                            var c = e.s[a].s;
        ...
        bind: function (a) {
            ...
            'undefined' != typeof a && (c(a), b.config.el.find('.item').removeClass('hover'), b.config.el.find('.item').eq(a - 1).addClass('hover'))
        },
        topRest: function () {
            var a = this;
...
/* jdf-1.0.0/ log.js Date:2015-12-31 15:16:39 */
!function () {
    if (!window.uba_lab_tag) {
        window.uba_lab_tag = !0;
        var a = {
            'www.jd.com': [
                '/div[id="category-item-1"]',
                '/div[id="category-item-2"]',
                '/div[id="category-item-3"]',
                '/div[id="category-item-4"]',
                '/div[id="category-item-5"]',
                '/div[id="category-item-6"]',
                '/div[id="category-item-7"]',
                '/div[id="category-item-8"]',
                '/div[id="category-item-9"]',
                '/div[id="category-item-10"]',
                '/div[id="category-item-11"]',
                '/div[id="category-item-12"]',
                '/div[id="category-item-13"]',
                '/div[id="category-item-14"]',
                '/div[id="category-item-15"]',
                '/li[id="ttbar-myjd"]/div[1]',
                '/li[id="ttbar-serv"]/div[1]',
                '/li[id="ttbar-navs"]/div[1]',
                '/div[id="clothes"]/div[1]/div[1]',
                '/div[id="clothes"]/div[1]/div[2]',
                '/div[id="clothes"]/div[1]/div[3]',
                '/div[id="clothes"]/div[1]/div[4]',
                '/div[id="clothes"]/div[1]/div[5]',
                '/div[id="clothes"]/div[1]/div[6]',
                '/div[id="clothes"]/div[1]/div[7]',
                '/div[id="clothes"]/div[1]/div[8]',
                '/div[id="clothes"]/div[1]/div[9]',
                '/div[id="cosmetics"]/div[1]/div[1]',
                '/div[id="cosmetics"]/div[1]/div[2]',
                '/div[id="cosmetics"]/div[1]/div[3]',
                '/div[id="cosmetics"]/div[1]/div[4]',
                '/div[id="cosmetics"]/div[1]/div[5]',
                '/div[id="cosmetics"]/div[1]/div[6]',
                '/div[id="cosmetics"]/div[1]/div[7]',
                '/div[id="cosmetics"]/div[1]/div[8]',
                '/div[id="cosmetics"]/div[1]/div[9]',
                '/div[id="mobiles"]/div[1]/div[1]',
                '/div[id="mobiles"]/div[1]/div[2]',
                '/div[id="mobiles"]/div[1]/div[3]',
                '/div[id="mobiles"]/div[1]/div[4]',
                '/div[id="mobiles"]/div[1]/div[5]',
                '/div[id="mobiles"]/div[1]/div[6]',
                '/div[id="mobiles"]/div[1]/div[7]',
                '/div[id="mobiles"]/div[1]/div[8]',
                '/div[id="electronics"]/div[1]/div[1]',
                '/div[id="electronics"]/div[1]/div[2]',
                '/div[id="electronics"]/div[1]/div[3]',
                '/div[id="electronics"]/div[1]/div[4]',
                '/div[id="electronics"]/div[1]/div[5]',
                '/div[id="electronics"]/div[1]/div[6]',
                '/div[id="electronics"]/div[1]/div[7]',
                '/div[id="electronics"]/div[1]/div[8]',
                '/div[id="electronics"]/div[1]/div[9]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[1]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[2]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[3]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[4]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[5]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[6]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[7]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[8]',
                '/div[id="digitalsfloorStyleA"]/div[1]/div[9]',
                '/div[id="sports"]/div[1]/div[1]',
                '/div[id="sports"]/div[1]/div[2]',
                '/div[id="sports"]/div[1]/div[3]',
                '/div[id="sports"]/div[1]/div[4]',
                '/div[id="sports"]/div[1]/div[5]',
                '/div[id="sports"]/div[1]/div[6]',
                '/div[id="sports"]/div[1]/div[7]',
                '/div[id="sports"]/div[1]/div[8]',
                '/div[id="sports"]/div[1]/div[9]',
                '/div[id="livings"]/div[1]/div[1]',
                '/div[id="livings"]/div[1]/div[2]',
                '/div[id="livings"]/div[1]/div[3]',
                '/div[id="livings"]/div[1]/div[4]',
                '/div[id="livings"]/div[1]/div[5]',
                '/div[id="livings"]/div[1]/div[6]',
                '/div[id="livings"]/div[1]/div[7]',
                '/div[id="livings"]/div[1]/div[8]',
                '/div[id="livings"]/div[1]/div[9]',
                '/div[id="babys"]/div[1]/div[1]',
                '/div[id="babys"]/div[1]/div[2]',
                '/div[id="babys"]/div[1]/div[3]',
                '/div[id="babys"]/div[1]/div[4]',
                '/div[id="babys"]/div[1]/div[5]',
                '/div[id="babys"]/div[1]/div[6]',
                '/div[id="babys"]/div[1]/div[7]',
                '/div[id="babys"]/div[1]/div[8]',
                '/div[id="babys"]/div[1]/div[9]',
                '/div[id="foods"]/div[1]/div[1]',
                '/div[id="foods"]/div[1]/div[2]',
                '/div[id="foods"]/div[1]/div[3]',
                '/div[id="foods"]/div[1]/div[4]',
                '/div[id="foods"]/div[1]/div[5]',
                '/div[id="foods"]/div[1]/div[6]',
                '/div[id="foods"]/div[1]/div[7]',
                '/div[id="foods"]/div[1]/div[8]',
                '/div[id="foods"]/div[1]/div[9]',
                '/div[id="books"]/div[1]/div[1]',
                '/div[id="books"]/div[1]/div[2]',
                '/div[id="books"]/div[1]/div[3]',
                '/div[id="books"]/div[1]/div[4]',
                '/div[id="books"]/div[1]/div[5]',
                '/div[id="books"]/div[1]/div[6]',
                '/div[id="books"]/div[1]/div[7]',
                '/div[id="books"]/div[1]/div[8]',
                '/div[id="books"]/div[1]/div[9]'
            ]
        };
        var b = {
            'www.jd.com': [
                '/li[id="ttbar-myjd"]/div[1]',
                '/div[id="ttbar-apps-main"]',
                '/div[id="ttbar-atte-main"]',
                '/li[id="ttbar-serv"]/div[1]',
                '/li[id="ttbar-navs"]/div[1]',
                '/li[id="d_',
        ...
        function e(a) {
            ...
            for (; c; c = c.nextSibling) if (1 === c.nodeType) {
                if (c === a) break;
                b += 1
            }
            return b
        ...
        function f(a) {
            ...
            if (c.indexOf('id') > - 1) {
                var e = /\".*?\"/gi;
                c = c.match(e) [0].replace(/\"/gi, function () {
                    return ''
                });
        ...
        function g(a) {
            if ('html' == a.nodeName.toLowerCase() || 'body' == a.nodeName.toLowerCase()) return null;
            var b = function (a) {
                var c = a.parentNode;
                var d = '';
                if (c) try {
                    ...
                    var g = /^ad\d+/gi;
                    f && !g.test(f) ? d += c.nodeName.toLowerCase() + '[id="' + c.getAttribute('id') + '"]/' : (d += c.nodeName.toLowerCase() + '[' + e(c) + ']/', d += b(c))
                } catch (h) {
                }
                return d
            };
            var c;
            return c = a.getAttribute('id') ? a.nodeName.toLowerCase() + '[id="' + a.getAttribute('id') + '"]/' : a.nodeName.toLowerCase() + '[' + e(a) + ']/' + b(a),
        ...
        function h(a) {
            ...
            if (!document.getElementById('tracelessLogDebug')) {
                ...
                var f = 900;
                var h = 20;
                e.id = 'tracelessLogDebug',
                    e.style.border = '1px #C81623 solid',
                    e.style.padding = '5px 10px',
                    e.style.width = f + 'px',
                    e.style.height = h + 'px',
                    e.style.background = '#C81623',
                    e.style.color = '#fff',
                    e.style.zIndex = 100,
                    e.style.opacity = 0.7,
                    ...
                    e.style.left = '50%',
                    e.style.top = '0px',
                    e.style.marginLeft = '-' + f / 2 + 'px',
                    document.getElementsByTagName('body') [0].appendChild(e)
            }
            'tracelessLogDebug' != b.getAttribute('id') && (document.getElementById('tracelessLogDebug').innerHTML = c),
                d.preventDefault(a)
        }
        var i = function (a, b) {
            var c = function (a) {
                for (var b = 0, c = 0; c < a.length; c++) b = (b << 5) - b + a.charCodeAt(c),
                    b &= b;
                return b
            };
        ...
        var m = j('pin') ? j('pin')  : '';
        var n = j('__jda') ? j('__jda').split('.') [1] : '';
        var o = j('__jdb') ? j('__jdb').split('.') [2] : '';
        var p = j('__jda') ? j('__jda').split('.') [5] : '';
        var q = 1;
        var r = function (a) {
            if (a.clientX > 1 && a.clientY > 1) {
                ...
                var e = 'cw=' + b + '$ch=' + c + '$sw=' + d + '$zb=' + p + '$labt=' + q;
                e = encodeURIComponent(e);
                var f = encodeURIComponent(document.referrer);
                var g = '//mercury.jd.com/log.gif?t=uas.000000&m=UA-J2011-1&pin=' + m + '&uid=' + n + '&sid=' + o + '&v=' + e + '&ref=' + f + '&rm=' + (new Date).getTime();
                l(g)
            }
        };
        var s = function (a) {
            var b = 'd=' + a + '$zb=' + p + '$labt=2';
            b = encodeURIComponent(b);
            var c = encodeURIComponent(document.referrer);
            var d = '//mercury.jd.com/log.gif?t=uas.000000&m=UA-J2011-1&pin=' + m + '&uid=' + n + '&sid=' + o + '&v=' + b + '&ref=' + c + '&rm=' + (new Date).getTime();
            l(d)
        };
        var t = function (a, b) {
            if (a.clientX > 1 && a.clientY > 1) {
                ...
                var i = 'cw=' + (e - d.left) + '$ch=' + (g - d.top) + '$sw=' + h + '$zb=' + p + '$labt=3$smid=' + b;
                i = encodeURIComponent(i);
                var j = encodeURIComponent(document.referrer);
                var q = '//mercury.jd.com/log.gif?t=uas.000000&m=UA-J2011-1&pin=' + m + '&uid=' + n + '&sid=' + o + '&v=' + i + '&ref=' + j + '&rm=' + (new Date).getTime();
                l(q)
            }
        };
        function u() {
            ...
            if (a) {
                ...
                function e() {
                    if (c.length > 0) {
                        for (var a = 0; a < c.length; a++) c[a].d = parseFloat(c[a].d.toFixed(2));
                        ...
                        g = window.setTimeout(function () {
                            h = d(),
                                ...
                                f = window.setInterval(function () {
                                    a && (document.hidden === !1 ? (i = !1, 0 === c.length ? (h.d = 0, c.push(h))  : h.d += 0.01)  : i === !1 && (e(), c = [
                                    ], i = !0))
                                }, 10)
                        }, 500)
                }
        ...
        /isdebug=(-\d)*-30/.test(location.search) && d.addHandler(document, 'click', function (a) {
            d.getEvent(a);
            h(a)
        }),
                    ...
                    success: function (e) {
                        e && $.each(e, function (f) {
                            ...
                            if (h.url && h.startOn && h.endOn && h.percent) {
                                var k = h.url.toLowerCase();
                                var l = /http.*?\/\//gi;
                                var m = location.href.toLowerCase();
                                if (m = m.replace(l, function () {
                                        return ''
                                    }), m.indexOf(k) > - 1 && j >= h.startOn && j <= h.endOn + 86400000 && i(n, 10000) <= 100 * parseInt(h.percent)) return d.addHandler(document, 'click', function (e) {
                                    var f = d.getEvent(e);
                                    if (b[k] ? c(b[k], g(d.getTarget(e))) || r(f)  : r(f), a[k]) {
                                        var h = c(a[k], g(d.getTarget(e)));
                                        h && t(f, h)
                                    }
                                }),
                                    u(),
