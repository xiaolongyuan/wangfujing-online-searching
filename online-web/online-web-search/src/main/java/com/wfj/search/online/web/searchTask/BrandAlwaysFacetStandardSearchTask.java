 ...
 * @since 1.0.0
 */
@Component("brandAlwaysFacetStandardSearchTask")
public class BrandAlwaysFacetStandardSearchTask extends BrandAlwaysFacetSearchTaskBase implements SearchTask {
