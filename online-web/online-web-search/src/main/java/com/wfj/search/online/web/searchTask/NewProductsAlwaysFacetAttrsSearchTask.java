 ...
 * @since 1.0.0
 */
@Component("newProductsAlwaysFacetAttrsSearchTask")
public class NewProductsAlwaysFacetAttrsSearchTask extends NewProductsAlwaysFacetSearchTaskBase implements SearchTask {
