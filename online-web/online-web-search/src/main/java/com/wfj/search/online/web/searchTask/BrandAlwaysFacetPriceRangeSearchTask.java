 ...
 * @since 1.0.0
 */
@Component("brandAlwaysFacetPriceRangeSearchTask")
public class BrandAlwaysFacetPriceRangeSearchTask extends BrandAlwaysFacetSearchTaskBase implements SearchTask {
    ...
    public void doSearch(SearchResult searchResult, SolrQuery baseQuery) {
        ...
        try {
            ...
            logger.error("加载排序规则失败, 0x530022", e);
            throw new RuntimeTrackingException(new TrackingException(e, "0x530022"));
        }
        ...
        if (rule == null) {
            logger.error("价格区间配置有问题, 0x530023");
            throw new RuntimeTrackingException(new TrackingException("0x530023"));
        }
    ...
    private void doFacetPriceRange(SolrQuery query, SearchResult searchResult, IntervalContentPojo rule) {
        ...
        try {
            ...
            logger.error("加载排序规则[{}]明细失败, 0x530024", rule.getSid(), e);
            throw new RuntimeTrackingException(new TrackingException(e, "0x530024"));
        }
        ...
        try {
            ...
            logger.error(msg + ", 0x530025", e);
            throw new RuntimeTrackingException(new TrackingException(e, "0x530025"));
        }
