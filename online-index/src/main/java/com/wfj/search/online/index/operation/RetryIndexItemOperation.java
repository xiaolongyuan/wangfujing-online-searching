 ...
 * @since 1.0.0
 */
@Component("retryIndexItemOperation")
public class RetryIndexItemOperation implements IOperation<Void> {
    @Autowired
    ...
    public Void operate(Operation opRecord) throws Exception {
        retryService.retryIndexItem(Long.parseLong(opRecord.getSid())).ifPresent(collector -> {
