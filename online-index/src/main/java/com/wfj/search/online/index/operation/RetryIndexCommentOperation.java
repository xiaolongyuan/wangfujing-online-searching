 ...
 * @since 1.0.0
 */
@Component("retryIndexCommentOperation")
public class RetryIndexCommentOperation implements IOperation<Void> {
    @Autowired
    ...
    public Void operate(Operation opRecord) throws Exception {
        retryService.retryIndexComment(Long.parseLong(opRecord.getSid())).ifPresent(collector -> {
